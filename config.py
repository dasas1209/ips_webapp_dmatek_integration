...
todas as constantes sao configuráveis via variaveis de ambiente no .env
...
# ---------------------------------------------------------------------------
# limites fisicos do mapa (fallback quando o mapa nao esta na BD)
# cada mapa real tem limite_x/limite_y proprios na tabela mapas do sqlite
# estes valores so sao usados se obter_limites_mapa() nao encontrar registo
# ---------------------------------------------------------------------------
